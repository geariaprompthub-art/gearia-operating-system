...
class Settings(BaseSettings):
    ...
    organization_create_ip_limit: int = Field(default=5, ge=1, le=100)
    organization_create_user_limit: int = Field(default=10, ge=1, le=100)
    organization_update_ip_limit: int = Field(default=20, ge=1, le=200)
    organization_update_user_limit: int = Field(default=20, ge=1, le=200)
    organization_update_organization_limit: int = Field(default=30, ge=1, le=200)
    organization_membership_update_ip_limit: int = Field(default=20, ge=1, le=200)
    organization_membership_update_user_limit: int = Field(default=20, ge=1, le=200)
    organization_membership_update_organization_limit: int = Field(default=30, ge=1, le=200)
    organization_membership_revoke_ip_limit: int = Field(default=20, ge=1, le=200)
    organization_membership_revoke_user_limit: int = Field(default=20, ge=1, le=200)
    organization_membership_revoke_organization_limit: int = Field(default=30, ge=1, le=200)
    organization_invitation_issue_ip_limit: int = Field(default=10, ge=1, le=200)
    organization_invitation_issue_user_limit: int = Field(default=20, ge=1, le=200)
    organization_invitation_issue_organization_limit: int = Field(default=30, ge=1, le=200)
    organization_invitation_issue_email_limit: int = Field(default=10, ge=1, le=200)
    organization_invitation_revoke_ip_limit: int = Field(default=20, ge=1, le=200)
    organization_invitation_revoke_user_limit: int = Field(default=20, ge=1, le=200)
    organization_invitation_revoke_organization_limit: int = Field(default=30, ge=1, le=200)
    organization_invitation_accept_ip_limit: int = Field(default=20, ge=1, le=200)
    organization_invitation_accept_user_limit: int = Field(default=20, ge=1, le=200)
    organization_workspace_create_ip_limit: int = Field(default=20, ge=1, le=200)
    organization_workspace_create_user_limit: int = Field(default=20, ge=1, le=200)
    organization_workspace_create_organization_limit: int = Field(default=30, ge=1, le=200)
